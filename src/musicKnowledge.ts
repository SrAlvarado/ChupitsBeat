...
export const GENRES: GenreSpec[] = [
  {
    ...
    kick: 'kick 909 saturado/distorsionado, decay corto, 4-on-floor implacable (la PIEZA central; pega como un ariete)',
    perc: 'hats afilados en corcheas/semicorcheas, open hat en el OFFBEAT, clap en 2 y 4, percusión metálica industrial en loops rodantes sincopados (euclid 3/16 o 5/16)',
    bass: 'bajo ESCASO sidechain al kick: sub oscuro corto o stabs atonales filtrados; el kick manda, deja hueco',
    palette: {
      drums: ['RolandTR909_bd', 'bd', 'hh', 'oh', 'cp', 'rim', 'perc', 'cr', 'sd'],
      synths: ['sawtooth', 'square'],
    },
    vibe: 'crudo, oscuro, hipnótico, industrial, locomotora implacable, energía de búnker',
